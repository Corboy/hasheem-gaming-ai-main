...
import { GameCommentsProvider } from "@/contexts/GameCommentsContext";
                    ...
                    <Routes>
                            ...
                            sections={[
                              {
                                ...
                                body: [
                                  ...
                                  "Live support: use the support widget on the bottom-right corner.",
                                ],
                              },
                              {
                      ...
                      <Route path="/admin" element={<RequireAdmin />}>
                        <Route element={<AdminLayout />}>
                          ...
                          <Route path="games/new" element={<AdminGameFormPage />} />
